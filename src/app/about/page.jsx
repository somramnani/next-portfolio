        ...
        <div className=" ">
          <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64">
            <div className="flex flex-col gap-12 justify-center">
              <h1 className="font-bold text-2">BIOGRAPHY</h1>
              <p classname="text-lg">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vitae
                omnis eum atque molestiae eligendi exercitationem impedit
                quisquam reiciendis porro neque qui corrupti est, officia
                similique commodi odio, provident quas id.
              </p>
              ...
              <div className="self-end">
                {/* <Image src="/signature.png" alt="" fill /> */}
                <svg
                  width="185"
                  height="77"
                  viewBox="0 0 370 114"
            ...
            <div className="flex flex-col gap-12 justify-center">
              <h1 className="font-bold text-2">SKILLS</h1>
