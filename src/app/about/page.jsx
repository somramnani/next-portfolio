      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              Since childhood, my deep fascination with technology has driven me
              to constantly expand my skills in various languages and
              frameworks. This passion led me to pursue a career in developing
              user-centric software within collaborative teams. With an
              Associate’s degree in Web Development, I've honed my proficiency
              through internships at Trendsetter Media & Marketing and currently
              at Formation, where I'm learning from senior engineers at top-tier
              companies like Meta, Nextdoor, and Amazon. My primary expertise
              lies in JavaScript (React, Node, etc.), HTML5, and CSS3, and I
              take pride in crafting elegant and scalable code.
            </p>
            {/* BIOGRAPHY QUOTE
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    ...
                    fundamentals through coding exercises with React/HTML/CSS
                    through independent study, pair programming, and small
                    mentor-led groups.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Contributed to a full stack application built on
                    NextJS(React Framework), Typescript, GraphQL and PostgreSQL.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    May 2021 - Nov 2021{" "}
